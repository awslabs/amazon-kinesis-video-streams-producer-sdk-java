...
public final class StreamInfoConstants {
    ...
    public static final long MAX_LATENCY_ZERO = 0L;
    public static final long MAX_LATENCY_IN_SECONDS = 120L * HUNDREDS_OF_NANOS_IN_A_SECOND;
     ...
     */
    public static final long DEFAULT_BUFFER_DURATION_IN_SECONDS = 40 * HUNDREDS_OF_NANOS_IN_A_SECOND;

    /**
     * Default replay duration for a stream
     */
    public static final long DEFAULT_REPLAY_DURATION_IN_SECONDS = 20 * HUNDREDS_OF_NANOS_IN_A_SECOND;

    /**
     * Default connection staleness detection duration.
     */
    public static final long DEFAULT_STALENESS_DURATION_IN_SECONDS = 20 * HUNDREDS_OF_NANOS_IN_A_SECOND;
